    ...
    <div>
      <div className="arp_content">
        ...
        <p>
          ...
          it is based on data offered from multiple lenders. Qualified consumers
          can get a loan with APR Rates ranging from 4.95% to a maximum of
          35.95% and loans repayment period of 61 to 90 days. Your loan amount,
          APR and repayment term will vary based on your credit worthiness,
          state and lender or lending partner. Important Information: Some
          lenders and services may not be accessible to residents of all States
          based on lender’s preferences and legislation particular to that
          State.
        </p>
        <p>
      ...
      <p>
        ...
        arrangement fee ($400), your monthly repayments would be $131.67, with a
        total pay back amount of $6320.12 which including the 8% fee paid from
        the loan amount, would have a total cost of $1720.12. Representative
        18.23% APR.
      </p>
    </div>
  );
